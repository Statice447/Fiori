		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (19)",
									"targetURL": "#examexprogram19-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram19-display": {
								"semanticObject": "examexprogram19",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram19",
									"url": sap.ui.require.toUrl("exam/exprogram19")
								}
							}
						}
					}
