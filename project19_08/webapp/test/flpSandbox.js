		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#odataproject1908-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject1908-display": {
								"semanticObject": "odataproject1908",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project1908",
									"url": sap.ui.require.toUrl("odata/project1908")
								}
							}
						}
					}
